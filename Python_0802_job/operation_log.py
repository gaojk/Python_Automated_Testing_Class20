...
stream_level = config.get_value(section="LOG", option="stream_level")
file_level = config.get_value(section="LOG", option="file_level")
log_format = config.get_value(section="LOG", option="log_format")
log_path = config.get_value(section="PATH", option="logpath")
